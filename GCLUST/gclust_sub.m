function gclust_mvl(datadir,roidir,matlabdir,outdir,subid)
%function geneclust(datadir,roidir,matlabdir,outdir,subid)
...
for i=1:length(measname_list)
    ...
    parms.subjlist = {subid};
    parms.outstem = sprintf('%s_%s',roistem,subid);
...
end % for i=1:length(measname_list)
